...
export default function AppRouter() { return <BrowserRouter><Routes><Route path="/" element={<Home />} /><Route path="/login" element={<Login />} /><Route path="/signup" element={<Signup />} /><Route path="/dashboard" element={<DashboardLayout />}><Route index element={<Dashboard />} /><Route path="stats" element={<Stats />} /><Route path="worker" element={<WorkerControl />} /><Route path="database" element={<Database />} /><Route path="promote" element={<Promote />} /></Route><Route path="*" element={<NotFound />} /></Routes></BrowserRouter>; }
