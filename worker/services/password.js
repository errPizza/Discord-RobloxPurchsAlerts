...
const COMMON_PASSWORDS = new Set([
  "password1!", "contraseña1!", "admin123!", "qwerty123!", "123456789012345", "1234567890123456", "adminadminadmin",
  "contraseña123456", "password123456", "qwertyuiop12345", "letmeinletmein", "iloveyouiloveyou", "anothergamemore", "pizza1234567890",
]);
...
export function passwordRequirements(password, email = "") {
  ...
  if (!/\p{Lu}/u.test(value)) return "La contraseña debe incluir al menos una mayúscula.";
  if ((value.match(/\p{Ll}/gu) || []).length < 2) return "La contraseña debe incluir al menos dos minúsculas.";
  if (!/\p{Nd}/u.test(value)) return "La contraseña debe incluir al menos un número.";
  if (!/[^\p{L}\p{N}\s]/u.test(value)) return "La contraseña debe incluir al menos un signo.";
