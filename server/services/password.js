...
const COMMON_PASSWORDS = new Set(["password1!", "contraseña1!", "admin123!", "qwerty123!", "123456789012345", "password123456", "contraseña123456", "anothergamemore"]);
...
export function passwordRequirements(password, email = "") {
  ...
  if (COMMON_PASSWORDS.has(password.toLowerCase())) return "La contraseña es demasiado común.";
